    ...
    return (
      <>
        ...
        <div className="container-main" style={{width:'70%'}}>
          ...
          <small style={{color:'black'}}>Number of Candidates: {this.state.candidateCount}</small>
            <form className="form">
              ...
              <label className={"label-ac"}>
                ...
                <input
                  className={"input-ac"}
                  type="text"
                  placeholder="eg. Hamara Neta kaisa ho, Sundar lal jaisa ho"
